...
const FES_DATA = [
  ...
  },
  {
    ...
    stalls: [
      ...
      { name: "制服リサイクル", place: "310", group: "後援会", description: "310教室にて制服リサイクル販売を行っています。あれもこれもこんなお値段で･･･！？ステキな掘り出し物に出会えるかも･･･！？どうぞ宝探しの気分でお越し下さい。", image: "" },
      { name: "後援会バザー", place: "スチューデントホール", group: "後援会", description: "スチューデントホールにて後援会バザーを行っています。スチューデントホールへお越しの際は、3階売店横連絡通路が近くて便利です。", image: "" },
      ...
      { name: "和風喫茶", place: "100周年記念ホール2階和室", group: "茶道部", description: "表千家不泊流のお点前でみな様をお迎えします。「和風喫茶」は、椅子に座ってお抹茶とお菓子を召し上がって頂く立礼のお茶席です。茶道体験で一服し、ぜひ和室でくつろぎの時間をお過ごし下さい。※100周年記念ホールの和室へお越しの際は、1階の外階段を2階まで昇るか、3階スチューデントホールから2階に降りてください。", image: "" },
