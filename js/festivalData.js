...
const FES_DATA = [
  ...
  },
  {
    ...
    stalls: [
      ...
      { name: "制服リサイクル", place: "310", group: "後援会", description: "310教室にて制服リサイクル販売を行っています。", image: "" },
      { name: "後援会バザー", place: "スチューデントホール", group: "後援会", description: "スチューデントホールにて後援会バザーを行っています。あれもこれもこんなお値段で･･･！？ステキな掘り出し物に出会えるかも･･･！？どうぞ宝探しの気分でお越し下さい。スチューデントホールへお越しの際は、3階売店横連絡通路が近くて便利です。", image: "" },
